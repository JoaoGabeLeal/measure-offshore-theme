<div class="especializados">
    <div class="container">
        <div class="row">
            <div class="col-20">
                <h6 class="titulo">
                    A Measure Offshore oferece serviços de calibração especializados, em conformidade com as diretrizes de comunicação marítima.
                </h6>
            </div>
        </div>
        <div class="row">
                ...
                <div class="especializados-lista">
                    <a href="http://" title="servicos de calibração de anemometro" class="especializados-item">
                        ...
                        <p class="descricao">
                            ...
                            até a unidade marítima e realiza a certificação do sensor de vento no 
                            helideque, torres ou guindastes.
                        </p>
                    ...
                    <a href="http://" title="servicos de calibração de anemometro" class="especializados-item">
                        ...
                        <p class="descricao">
                            ...
                            e Heave. Após a verificação, emitimos o certificado correspondente, 
                            garantindo conformidade e confiabilidade em suas operações.
                        </p>
                        <span class="orcamento-rapido">Orçamento rápido</span>
                    </a>
                    <a href="http://" title="servicos de calibração de anemometro" class="especializados-item">
